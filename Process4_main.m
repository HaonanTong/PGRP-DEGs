...
[ fig, ngenes ] = plotTable( ...
    'Profies-Genes-ANan-Gene-list-DEG-down-regulated-Not-all-down.csv' );
...
% Figure2
[ fig, ngenes ] = plotTable( ...
    'Profiles-ANan-up-regulated.csv' );
...
% Figure3
[ fig, ngenes ] = plotTable( ...
    'Profiles-ANan-down-regulated.csv' );
...
% Figure4
[ fig, ngenes ] = plotTable( ...
    'Profiles-Genes-ANan-Gene-list-DEG-up-regulated-Not-all-up.csv' );
